...
"""
========================================
API-методы с постами
========================================
"""


@router.post('/post', response_model=schemas.Post)
def create_post(post: schemas.PostGroupCreate, db: Session = Depends(get_db)):
...
@router.get('/post/{group_id}', response_model=list[schemas.Post])
def get_list_post_group(group_id: int, db: Session = Depends(get_db)):
...
@router.get('/post/{post_id}/group')
def get_group_for_post(post_id: int, db: Session = Depends(get_db)):
...
@router.get('/subscribe/all/{group_id}', response_model=list[schemas.Subscriber])
